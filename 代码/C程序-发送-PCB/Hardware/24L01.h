...
#define READ_REG_24     0x00  // Define read command to register
#define WRITE_REG_24    0x20  // Define write command to register
...
#define CONFIG_24       0x00  // 'Config' register address
